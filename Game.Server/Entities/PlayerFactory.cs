...
namespace Game.Server.Entities
{
    ...
    public static class PlayerFactory
    {
        ...
        {
            var shotgun = WeaponFactory.CreateShotgun(world).Reference();
            var bow = WeaponFactory.CreateBow(world).Reference();
            ...
            var playerEntity = world.Create(
                ...
                new HotbarComponent { SelectedIndex = 0, Hotbar = new List<EntityReference>() { bow, shotgun } },
